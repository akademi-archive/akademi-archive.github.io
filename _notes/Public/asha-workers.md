...
author: "Saumya Kalia"
author-bio: "SAUMYA KALIA is a writer based out of Delhi."
cover-art: /assets/img/akademi/0c725e_abcf7d8b1bbf41699dc5c985d991a1b2_mv2.jpg
...
Between 7 to 9 August this year, over 600,000 ASHAs went on a strike alongside [other trade unions](http://citucentre.org/676-successful-strike-of-scheme-workers-thousands-of-asha-and-anganwadi-workers-went-on-strike-on-the-first-day-of-the-two-days-strike-on-7-8-august-2020) in India. They demanded better pay, medical protection, regular COVID-19 testing, and the status of government employees. As shadow workers, ASHAs have emerged to be India’s national pride – and shame.
...
The colour pink has long symbolized the Accredited Social Health Activist (ASHA).. Globally, she and one million other women form the [world’s largest](https://chwcentral.org/resources/how-are-gender-inequalities-facing-indias-one-million-ashas-being-addressed-policy-origins-and-adaptations-for-the-worlds-largest-all-female-community-health-worker-programme/) all-female community health worker programme (CHW).

ASHAs offer a much-needed recourse to the public healthcare system, which is in itself an exposed flank characterised by lack of funds and staff. For [every 1,800](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3724242/#:~:text=Today%2C%20the%20number%20of%20registered,of%20rural%20health%20delivery%20system.) people in India, there is one doctor and roughly two nurses. Since 2005, ASHAs have been entrusted with bridging the knowledge gap between people in rural areas and urban slums – where [65 percent](https://tradingeconomics.com/india/rural-population-percent-of-total-population-wb-data.html#:~:text=Rural%20population%20(%25%20of%20total,compiled%20from%20officially%20recognized%20sources.) of the country’s population resides –  of healthcare policies. As these women uphold a waning system, their identity becomes inextricably tied to being an ASHA.
...
The [official module](https://nhm.gov.in/images/pdf/communitisation/task-group-reports/guidelines-on-asha.pdf) mentions a commitment of three-four hours per day, two-three times a week for ASHA volunteers. However, this materialises into significantly longer hours for most ASHAs. According to an International Labour Organisation (ILO) [report](https://www.ilo.org/wcmsp5/groups/public/---dgreports/---dcomm/documents/publication/wcms_616210.pdf), they were clocking in five-six hours almost every day of the week, which was considered to be a conservative estimation.
...
To add to their woes is their technological struggle with [ASHA-Soft](https://ashasoft.raj.nic.in/Private/login.aspx), the application for logging their work. The government has rallied towards digitising grass roots operations but it remains inaccessible. The idea of digital inclusivity holds little weight in a scenario where women are not allowed to own smartphones or if they are, receive no training on how to use them. Several ASHAs rely on other volunteers to log in their data for them.

The government’s response to their demands has come in a piece-meal fashion. In 2018, they [agreed to double](https://nhm.gov.in/New_Updates_2018/In_Focus/ASHA_Incentives.pdf) their fixed monthly honorarium from Rs. 1,000 following a nation-wide agitation. Other demands like logistical support, social security benefits, and smartphones were also agreed to after a month’s strike. But many of these are yet to be implemented.
...
The insult to injury becomes more pronounced as they shell out money from personal savings to buy gloves and sanitisers or for travel costs. The work had intensified, the role had become essential, their lives were at risk. Till date, [almost 20 ASHAs have succumbed to the disease.](https://www.thehindu.com/society/at-the-forefront-of-indias-healthcare-system-asha-workers-soldier-on-unprotected-and-poorly-paid/article31979010.ece) 
...
Moreover, their safety and mobility were threatened even prior to COVID-19. In 2016, after the gang-rape and death of an ASHA worker in Uttar Pradesh, a [fact-finding report](https://www.sabrangindia.in/tags/muzaffarnagar?page=1) expounded the rampant gender and caste-based violence ASHAs face. Offenders are mostly from the same village or are men of influence. Restitution, then, is seldom chosen.  
  
Popular perception of an ASHA is rooted in the notion that care work is inherent to women. As an all-female cadre, ASHAs are seen to be advantageously placed to tend to children and women’s reproductive health in a culturally-appropriate way.
...
What explains the institutional qualms about regularising ASHAs? A simple answer would be that if ASHAs are integrated into the bureaucratic mould, it [might jeopardise their acceptability](https://blogs.lse.ac.uk/southasia/2019/10/22/where-are-indias-working-women-the-fall-and-fall-of-indias-female-labour-participation-rate/) in the community. Additionally, bureaucrats believe the channel of communication functions one way, with information trickling down to ASHAs instead of up from them.
